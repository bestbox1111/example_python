...
def merger_image():
    ...
    # 포맷 옵션 처리
    # file_name="kingwangjjang."+ img_format    포맷옵션을 위해 추가된 사항
    dest_path=os.path.join(txt_dest_path.get(), "kingwangjjangsfood.png")    #이미지가 저장되는 경로에 file_name부분도 추가됨
